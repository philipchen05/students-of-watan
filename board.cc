...
void Board::populateCriterionMap() {
    criterionMap = {
        ...
        {19, {{13, 18, 25}, {21, 26, 30}}}, // corrent so far
        {20, {{9, 41, 42}, {19, 40, 41}}},
        {21, {{10, 43, 44}, {20, 42, 43}}},
        {22, {{10, 45, 46}, {21, 44, 45}}},
        {23, {{11, 47, 48}, {22, 46, 47}}},
        {24, {{11, 49, 50}, {23, 48, 49}}},
        {25, {{12, 51, 52}, {24, 50, 51}}},
        {26, {{12, 53, 54}, {25, 52, 53}}},
        {27, {{13, 55, 56}, {26, 54, 55}}},
        {28, {{13, 57, 58}, {27, 56, 57}}},
        {29, {{14, 59, 60}, {28, 58, 59}}},
        {30, {{14, 61, 62}, {29, 60, 61}}},
        {31, {{15, 63, 64}, {30, 62, 63}}},
        {32, {{15, 65, 66}, {31, 64, 65}}},
        {33, {{16, 67, 68}, {32, 66, 67}}},
        {34, {{16, 69, 70}, {33, 68, 69}}},
        {35, {{17, 71}, {34, 70}}},
        {36, {{18, 72}, {35, 71}}},
        {37, {{19, 73}, {36, 72}}},
        {38, {{20, 74}, {37, 73}}},
